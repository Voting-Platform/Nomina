...
import { notFound } from "next/navigation";import { Tabs, TabsList, TabsTrigger, TabsContent } from "@/components/ui/tabs";
import {
  CandidatesManager,
  EditElectionForm,
  RulesManager,
  ...
  ResultsView,
  ShareManager,
  StatusBadge, StatCard, Badge, Separator
} from "@/components";
import {
  LayoutDashboard,
  Pencil,
  ...
  return (
    <Tabs defaultValue="overview">
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 gap-3 sm:grid-cols-4 sm:gap-4">
            ...
            <StatCard
              icon={Calendar}
              label="Created"
              value={new Date(election.createdAt).toLocaleDateString("en-US", {
                month: "short",
                day: "numeric",
              })}
            />
              ...
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  ...
                  <span className="font-medium text-[var(--text-primary)]">
                    {election.maxTotalVotesPerVoter}
                  </span>
                </div>
                <div className="flex justify-between">
      ...
      <TabsContent value="edit">
        <EditElectionForm electionId={id} initialData={election} />
      </TabsContent>

      <TabsContent value="candidates">
        <CandidatesManager electionId={id} initialData={election} />
      </TabsContent>

      <TabsContent value="rules">
        <RulesManager electionId={id} initialData={election} />
      </TabsContent>

      <TabsContent value="schedule">
        <ScheduleManager electionId={id} initialData={election} />
      </TabsContent>
      ...
      <TabsContent value="results">
        <ResultsView electionId={id} initialData={election} />
      </TabsContent>
    </Tabs>
  )};